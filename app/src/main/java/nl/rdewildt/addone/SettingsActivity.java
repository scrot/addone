...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.statsMaintainer = new StatsMaintainer(getApplicationContext());
        setupActionBar();
    }
    ...
    public static class CounterPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            findPreference("counter").setOnPreferenceChangeListener((preference, o) -> {
                StatsMaintainer statsMaintainer = new StatsMaintainer(getContext());
                statsMaintainer.setStats(new Stats(Integer.parseInt(o.toString())));
                preference.setSummary(statsMaintainer.getStats().getCounter());
                return true;
            });
        }
